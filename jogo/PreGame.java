...
public class PreGame extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent e){		
			...
			for(int j = 0; j<10 ; j++){
				if(object == table[i][j]){
					...
					if(qual != 0 && escolheu==0){
						...
						JOptionPane.showMessageDialog(this," Agora clicke em outro botão para colocar o barco nessa direção.Veja se tem espaço, vc não vai bugar o jogo só vai perder tempo :D");
						escolheu=2;
					}
					if(escolheu==1){
						int dire=0;
		...
		if(barcosali[0]!=null && barcosali[1]!=null && barcosali[2]!=null && barcosali[3]!=null){
			...
			JOptionPane.showMessageDialog(this,"Clicke em qualquer botão da janela do jogo para começar o jogo");
			this.dispose();
		}
		if(object==voltar){

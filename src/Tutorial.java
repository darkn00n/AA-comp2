...
public class Tutorial extends JFrame implements ActionListener {
	...
	public void addComponentsToPane() {
		...
		ImageIcon Voltar = new ImageIcon("botoes//NextJ.jpg"); // Imagem que sera utilizada no primeiro botao	
		ImageIcon VoltarS = new ImageIcon("botoes//NextJS.jpg");
